...
data Entry f = FunctionE (f String) (f String)
             | DataTypeE (f String)
             | ConstructorE (Either (f String, f String) (f (Var Int String), f (Var Int String)))

data ScopeState f = ScopeState
    { functions    :: [(String, (f String, f String))]
    , dataTypes    :: [(String, f String)]
    , constructors :: [((String, String), Either (f String, f String) (f (Var Int String), f (Var Int String)))]
    }
...
addConstructor :: (Monad f, Monad m) => String -> String
    -> Either (f String, f String) (f (Var Int String), f (Var Int String)) -> ScopeT f m ()
addConstructor con dt ty = ScopeT $ modify $ \scope -> scope { constructors = ((con, dt), ty) : constructors scope }
...
getConstructor :: Monad m => String -> Maybe String -> ScopeT f m [Either (f String, f String) (f (Var Int String), f (Var Int String))]
